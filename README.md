...
<!-- USAGE EXAMPLES -->
## Usage
Use MySQL to create a database called 'employees' and you'll probably have to change the user and passwords provided in server.js.
<!--Use this space to show useful examples of how a project can be used. Additional screenshots, code examples and demos work well in this space. You may also link to more resources.-->
[Link to walkthrough video](https://drive.google.com/file/d/1jj-tsFSgkCPBD2zuNdvyidO02TiTZrPe/view)
...
See the [open issues](https://github.com/alexo-a/employee-tracker/issues) for a list of proposed features (and known issues).
...
Project Link: [https://github.com/alexo-a/employee-tracker](https://github.com/alexo-a/employee-tracker)
